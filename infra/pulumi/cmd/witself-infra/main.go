...
flags:
  ...
  -domain        parent domain for cell hostnames               (default "cell.witwave.ai")
...
func run(args []string) error {
	...
	domain := fs.String("domain", cell.DefaultDomain, "parent domain for cell hostnames, e.g. cell.witwave.ai")
