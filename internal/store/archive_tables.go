...
var cellLocalArchiveExclusions = map[string]struct{}{
	...
	"agent_email_cell_storage_capacity":        {},
...
var canonicalArchiveTables = []archiveTableIntroduction{
	...
	{name: "agent_email_realm_receive_controls", introducedSchema: 60},
	{name: "agent_email_realm_send_controls", introducedSchema: 89},
	...
	{name: "agent_email_send_controls", introducedSchema: 89},
	...
	{name: "agent_email_outbound_messages", introducedSchema: 89},
	{name: "agent_email_outbound_provider_events", introducedSchema: 89},
	{name: "agent_email_outbound_recipient_suppressions", introducedSchema: 89},
