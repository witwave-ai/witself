...
func TestVerbRegistryCoverage(t *testing.T) {
	verbs := []string{
		...
		VerbAgentEmailAddressProvisioned, VerbAgentEmailReceived,
		VerbAgentEmailRead, VerbAgentEmailAcked, VerbAgentEmailCodeConsumed,
		...
		VerbAgentEmailRealmAliasProjected, VerbAgentEmailCustomDomainRouteProjected,
