...
func TestRuntimeCapabilityConformance(t *testing.T) {
	tests := []struct {
		...
		{transcriptcapture.RuntimeCopilot, false, false, DeliveryGuidedMCPFallback, DeliveryGuidedMCPFallback},
		{transcriptcapture.RuntimeDSH, false, false, DeliveryGuidedMCPFallback, DeliveryGuidedMCPFallback},
	}
