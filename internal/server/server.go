...
func apiMux(cfg Config) http.Handler {
	...
	secretsSupported := cfg.AuthenticatePrincipal != nil &&
		...
		cfg.CreateSecret != nil && cfg.ListSecrets != nil && cfg.GetSecret != nil &&
		cfg.ArchiveSecret != nil && cfg.RestoreSecret != nil && cfg.AccessSecretField != nil
	...
	if cfg.AuthenticatePrincipal != nil {
		...
		if cfg.ArchiveSecret != nil || cfg.RestoreSecret != nil {
