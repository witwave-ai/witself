...
type Config struct {
	...
	// ApplyAccountPlanIfFits is the provision-token-gated atomic downgrade
	// boundary. The cell locks the account, rechecks durable usage, and either
	// applies the exact fenced target or returns a bounded refusal plus the
	// current persisted snapshot from that same transaction.
	...
	// sensitive value.
	GetCurrentVaultKey        func(ctx context.Context, p DomainPrincipal) (*VaultKeyBinding, error)
	RegisterVaultKey          func(ctx context.Context, p DomainPrincipal, in RegisterVaultKeyRequest) (VaultKeyMutationResult, error)
	CreateVaultKeyEnrollment  func(ctx context.Context, p DomainPrincipal, in CreateVaultKeyEnrollmentRequest) (VaultKeyEnrollment, error)
	ListVaultKeyEnrollments   func(ctx context.Context, p DomainPrincipal, opts VaultKeyEnrollmentListOptions) ([]VaultKeyEnrollment, error)
	GetVaultKeyEnrollment     func(ctx context.Context, p DomainPrincipal, enrollmentID string) (VaultKeyEnrollment, error)
	ApproveVaultKeyEnrollment func(ctx context.Context, p DomainPrincipal, enrollmentID string, in ApproveVaultKeyEnrollmentRequest) (VaultKeyEnrollment, error)
	ReceiveVaultKeyEnrollment func(ctx context.Context, p DomainPrincipal, enrollmentID, targetLocationID string) (VaultKeyEnrollmentTransfer, error)
	ConsumeVaultKeyEnrollment func(ctx context.Context, p DomainPrincipal, enrollmentID string, in ConsumeVaultKeyEnrollmentRequest) (VaultKeyEnrollment, error)
	CancelVaultKeyEnrollment  func(ctx context.Context, p DomainPrincipal, enrollmentID string, in CancelVaultKeyEnrollmentRequest) (VaultKeyEnrollment, error)
	StartVaultKeyRotation     func(ctx context.Context, p DomainPrincipal, in StartVaultKeyRotationRequest) (VaultKeyRotationMutationResult, error)
	GetOpenVaultKeyRotation   func(ctx context.Context, p DomainPrincipal) (*VaultKeyRotation, error)
	GetVaultKeyRotation       func(ctx context.Context, p DomainPrincipal, rotationID string) (VaultKeyRotation, error)
	ListVaultKeyRotationItems func(ctx context.Context, p DomainPrincipal, rotationID string, opts VaultKeyRotationItemListOptions) (VaultKeyRotationItemPage, error)
	StageVaultKeyRotation     func(ctx context.Context, p DomainPrincipal, rotationID string, in StageVaultKeyRotationRequest) (VaultKeyRotationMutationResult, error)
	CommitVaultKeyRotation    func(ctx context.Context, p DomainPrincipal, rotationID string, in CommitVaultKeyRotationRequest) (VaultKeyRotationMutationResult, error)
	CancelVaultKeyRotation    func(ctx context.Context, p DomainPrincipal, rotationID string, in CancelVaultKeyRotationRequest) (VaultKeyRotationMutationResult, error)
	CreateSecret              func(ctx context.Context, p DomainPrincipal, in CreateSecretRequest) (SecretMutationResult, error)
	GetSecretLimitStatus      func(ctx context.Context, p DomainPrincipal) (SecretLimitStatus, error)
	ListSecrets               func(ctx context.Context, p DomainPrincipal, opts SecretListOptions) (SecretPage, error)
	GetSecret                 func(ctx context.Context, p DomainPrincipal, secretID string) (Secret, error)
	ArchiveSecret             func(ctx context.Context, p DomainPrincipal, secretID string, in SecretLifecycleRequest) (SecretMutationResult, error)
	RestoreSecret             func(ctx context.Context, p DomainPrincipal, secretID string, in SecretLifecycleRequest) (SecretMutationResult, error)
	DeleteSecret              func(ctx context.Context, p DomainPrincipal, secretID string, in SecretLifecycleRequest) (SecretMutationResult, error)
	...
	// Agent avatars are generated by active AI clients and persisted as
	// immutable sanitized versions. Self callbacks always receive the exact
	// token-derived agent principal; callers cannot select account, realm, or
	// agent identity through JSON or query parameters.
	GetSelfAvatar                     func(ctx context.Context, p DomainPrincipal) (AvatarView, error)
	GetSelfAvatarHistory              func(ctx context.Context, p DomainPrincipal, opts AvatarHistoryOptions) (AvatarHistoryPage, error)
	GetSelfAvatarVersion              func(ctx context.Context, p DomainPrincipal, version int64) (AvatarVersion, error)
	GetSelfAvatarStyle                func(ctx context.Context, p DomainPrincipal) (AvatarStyleView, error)
	ProposeSelfAvatar                 func(ctx context.Context, p DomainPrincipal, in ProposeAvatarRequest) (AvatarMutationResult, error)
	ActivateSelfAvatar                func(ctx context.Context, p DomainPrincipal, in ActivateAvatarRequest) (AvatarMutationResult, error)
	RollbackSelfAvatar                func(ctx context.Context, p DomainPrincipal, in RollbackAvatarRequest) (AvatarMutationResult, error)
	ResetSelfAvatar                   func(ctx context.Context, p DomainPrincipal, in ResetAvatarRequest) (AvatarMutationResult, error)
	ReportSelfAvatarGenerationFailure func(ctx context.Context, p DomainPrincipal, in AvatarGenerationFailureRequest) (AvatarMutationResult, error)

	// Operator avatar callbacks receive account and operator identity derived
	// from Authenticate. Agent and realm path values are account-scoped targets,
	// never alternate authority supplied by the request body.
	GetAgentAvatar                func(ctx context.Context, accountID, operatorID, agentID string) (AvatarView, error)
	GetAgentAvatarHistory         func(ctx context.Context, accountID, operatorID, agentID string, opts AvatarHistoryOptions) (AvatarHistoryPage, error)
	GetAgentAvatarVersion         func(ctx context.Context, accountID, operatorID, agentID string, version int64) (AvatarVersion, error)
	ProposeAgentAvatar            func(ctx context.Context, accountID, operatorID, agentID string, in ProposeAvatarRequest) (AvatarMutationResult, error)
	ActivateAgentAvatar           func(ctx context.Context, accountID, operatorID, agentID string, in ActivateAvatarRequest) (AvatarMutationResult, error)
	RejectAgentAvatar             func(ctx context.Context, accountID, operatorID, agentID string, in RejectAvatarRequest) (AvatarMutationResult, error)
...
// PlanFitApplyTargetRecord is the complete resolved target plus its positive
// monotonic revision fence.
type PlanFitApplyTargetRecord struct {
	Revision     int64            `json:"revision"`
	Plan         string           `json:"plan"`
	SnapshotHash string           `json:"snapshot_hash"`
	Limits       map[string]int64 `json:"limits"`
...
// PlanFitApplyResult is deliberately mutually exclusive: applied carries an
// applied snapshot and no violations/current snapshot; blocked carries at
// least one violation and the exact current snapshot but no applied snapshot.
type PlanFitApplyResult struct {
	SchemaVersion      string              `json:"schema_version"`
	State              string              `json:"state"`
	AccountID          string              `json:"account_id"`
	...
	TargetSnapshotHash string              `json:"target_snapshot_hash"`
	Violations         []PlanFitViolation  `json:"violations"`
	CurrentSnapshot    *PlanSnapshotRecord `json:"current_snapshot,omitempty"`
	AppliedSnapshot    *PlanSnapshotRecord `json:"applied_snapshot,omitempty"`
}
...
func validPlanFitApplyTargetRecord(target PlanFitApplyTargetRecord) bool {
	return target.Revision > 0 && validPlanFitTargetRecord(PlanFitTargetRecord{
		Plan: target.Plan, SnapshotHash: target.SnapshotHash,
		Limits: target.Limits, Policies: target.Policies, Features: target.Features,
	})
}

func validPlanFitApplyResult(
	accountID string,
	target PlanFitApplyTargetRecord,
	result PlanFitApplyResult,
) bool {
	if result.AccountID != accountID || result.TargetRevision != target.Revision ||
		result.TargetPlan != target.Plan ||
		result.TargetSnapshotHash != target.SnapshotHash ||
		result.Violations == nil {
		return false
	}
	switch result.State {
	case PlanFitApplyStateApplied:
		return len(result.Violations) == 0 && result.CurrentSnapshot == nil &&
			result.AppliedSnapshot != nil &&
			planSnapshotMatchesFitApplyTarget(*result.AppliedSnapshot, accountID, target)
	case PlanFitApplyStateBlocked:
		if len(result.Violations) == 0 || result.CurrentSnapshot == nil ||
			result.AppliedSnapshot != nil ||
			result.CurrentSnapshot.Revision >= target.Revision ||
			!validPlanSnapshotRecord(*result.CurrentSnapshot, accountID) {
			return false
		}
		return validPlanFitViolations(target.Limits, result.Violations)
	default:
		return false
	}
}

func planSnapshotMatchesFitApplyTarget(
...
func validPlanSnapshotRecord(snapshot PlanSnapshotRecord, accountID string) bool {
	...
	return err == nil && snapshot.SnapshotHash == expected && snapshot.AppliedAt != nil
}

func validPlanFitViolations(
	limits map[string]int64,
	violations []PlanFitViolation,
) bool {
	seen := make(map[string]struct{}, len(violations))
	for _, violation := range violations {
		maximum, finite := limits[violation.Dimension]
		if !finite || maximum != violation.Max || violation.Code != "limit_exceeded" ||
			violation.Used <= violation.Max || violation.SubjectCount < 1 {
			return false
		}
		expectedScope, ok := planFitScopeForDimension(violation.Dimension)
		if !ok || violation.Scope != expectedScope {
			return false
		}
		if expectedScope == "account" && violation.SubjectCount != 1 {
			return false
		}
		if _, duplicate := seen[violation.Dimension]; duplicate {
			return false
		}
		seen[violation.Dimension] = struct{}{}
	}
	return true
}

func planFitScopeForDimension(dimension string) (string, bool) {
	switch dimension {
...
// avatar that needs one bounded foreground action from an active AI client.
// It never carries SVG, prompts, descriptions, or visual specifications.
...
func apiMux(cfg Config) http.Handler {
	...
	if cfg.Authenticate != nil {
		...
		if cfg.GetAgentAvatar != nil {
			mux.HandleFunc("GET /v1/agents/{agent}/avatar", getAgentAvatarHandler(cfg.Authenticate, cfg.GetAgentAvatar))
		}
		if cfg.GetAgentAvatarHistory != nil {
			mux.HandleFunc("GET /v1/agents/{agent}/avatar/history", getAgentAvatarHistoryHandler(cfg.Authenticate, cfg.GetAgentAvatarHistory))
		}
		if cfg.GetAgentAvatarVersion != nil {
			mux.HandleFunc("GET /v1/agents/{agent}/avatar/versions/{version}", getAgentAvatarVersionHandler(cfg.Authenticate, cfg.GetAgentAvatarVersion))
		}
		if cfg.ProposeAgentAvatar != nil {
			mux.HandleFunc("POST /v1/agents/{agent}/avatar/proposals", proposeAgentAvatarHandler(cfg.Authenticate, cfg.ProposeAgentAvatar))
		}
		if cfg.ActivateAgentAvatar != nil {
			mux.HandleFunc("POST /v1/agents/{agent}/avatar:activate", activateAgentAvatarHandler(cfg.Authenticate, cfg.ActivateAgentAvatar))
		}
		if cfg.RejectAgentAvatar != nil {
			mux.HandleFunc("POST /v1/agents/{agent}/avatar:reject", rejectAgentAvatarHandler(cfg.Authenticate, cfg.RejectAgentAvatar))
		}
		if cfg.RollbackAgentAvatar != nil {
			mux.HandleFunc("POST /v1/agents/{agent}/avatar:rollback", rollbackAgentAvatarHandler(cfg.Authenticate, cfg.RollbackAgentAvatar))
		}
		if cfg.ResetAgentAvatar != nil {
			mux.HandleFunc("POST /v1/agents/{agent}/avatar:reset", resetAgentAvatarHandler(cfg.Authenticate, cfg.ResetAgentAvatar))
		}
	...
	if cfg.AuthenticatePrincipal != nil {
		...
		if cfg.GetCurrentVaultKey != nil {
			mux.HandleFunc("GET /v1/vault/key-epochs/current", getCurrentVaultKeyHandler(cfg.AuthenticatePrincipal, cfg.GetCurrentVaultKey))
		}
		if cfg.CreateVaultKeyEnrollment != nil {
			mux.HandleFunc("POST /v1/vault/enrollments", createVaultKeyEnrollmentHandler(cfg.AuthenticatePrincipal, cfg.CreateVaultKeyEnrollment))
		}
		if cfg.ListVaultKeyEnrollments != nil {
			mux.HandleFunc("GET /v1/vault/enrollments", listVaultKeyEnrollmentsHandler(cfg.AuthenticatePrincipal, cfg.ListVaultKeyEnrollments))
		}
		if cfg.GetVaultKeyEnrollment != nil {
			mux.HandleFunc("GET /v1/vault/enrollments/{enrollment}", getVaultKeyEnrollmentHandler(cfg.AuthenticatePrincipal, cfg.GetVaultKeyEnrollment))
		}
		if cfg.ApproveVaultKeyEnrollment != nil || cfg.ReceiveVaultKeyEnrollment != nil ||
			cfg.ConsumeVaultKeyEnrollment != nil || cfg.CancelVaultKeyEnrollment != nil {
			mux.HandleFunc("POST /v1/vault/enrollments/{action}", vaultKeyEnrollmentActionHandler(
				cfg.AuthenticatePrincipal, cfg.ApproveVaultKeyEnrollment, cfg.ReceiveVaultKeyEnrollment,
				cfg.ConsumeVaultKeyEnrollment, cfg.CancelVaultKeyEnrollment))
		}
		if cfg.StartVaultKeyRotation != nil {
			mux.HandleFunc("POST /v1/vault/rotations", startVaultKeyRotationHandler(
				cfg.AuthenticatePrincipal, cfg.StartVaultKeyRotation))
		}
		if cfg.GetOpenVaultKeyRotation != nil {
			mux.HandleFunc("GET /v1/vault/rotations/open", getOpenVaultKeyRotationHandler(
				cfg.AuthenticatePrincipal, cfg.GetOpenVaultKeyRotation))
		}
		if cfg.GetVaultKeyRotation != nil {
			mux.HandleFunc("GET /v1/vault/rotations/{rotation}", getVaultKeyRotationHandler(
				cfg.AuthenticatePrincipal, cfg.GetVaultKeyRotation))
		}
		if cfg.ListVaultKeyRotationItems != nil {
			mux.HandleFunc("GET /v1/vault/rotations/{rotation}/items", listVaultKeyRotationItemsHandler(
				cfg.AuthenticatePrincipal, cfg.ListVaultKeyRotationItems))
		}
		if cfg.StageVaultKeyRotation != nil || cfg.CommitVaultKeyRotation != nil || cfg.CancelVaultKeyRotation != nil {
			mux.HandleFunc("POST /v1/vault/rotations/{action}", vaultKeyRotationActionHandler(
				cfg.AuthenticatePrincipal, cfg.StageVaultKeyRotation,
				cfg.CommitVaultKeyRotation, cfg.CancelVaultKeyRotation))
		}
		if cfg.CreateSecret != nil {
			mux.HandleFunc("POST /v1/secrets", createSecretHandler(cfg.AuthenticatePrincipal, cfg.CreateSecret))
		}
		if cfg.GetSecretLimitStatus != nil {
			mux.HandleFunc("GET /v1/secrets:status", secretLimitStatusHandler(
				cfg.AuthenticatePrincipal, cfg.GetSecretLimitStatus))
		}
		if cfg.ListSecrets != nil {
			mux.HandleFunc("GET /v1/secrets", listSecretsHandler(cfg.AuthenticatePrincipal, cfg.ListSecrets))
		}
		if cfg.GetSecret != nil {
			mux.HandleFunc("GET /v1/secrets/{secret}", getSecretHandler(cfg.AuthenticatePrincipal, cfg.GetSecret))
		}
		if cfg.ArchiveSecret != nil || cfg.RestoreSecret != nil || cfg.DeleteSecret != nil {
			mux.HandleFunc("POST /v1/secrets/{action}", secretLifecycleHandler(
				cfg.AuthenticatePrincipal, cfg.ArchiveSecret, cfg.RestoreSecret,
				cfg.DeleteSecret))
		}
		if cfg.AccessSecretField != nil {
			mux.HandleFunc("POST /v1/secrets/{secret}/fields/{action}", accessSecretFieldHandler(cfg.AuthenticatePrincipal, cfg.AccessSecretField))
		}
		if cfg.GetSelfAvatar != nil {
			mux.HandleFunc("GET /v1/self/avatar", getSelfAvatarHandler(cfg.AuthenticatePrincipal, cfg.GetSelfAvatar))
		}
		if cfg.GetSelfAvatarHistory != nil {
			mux.HandleFunc("GET /v1/self/avatar/history", getSelfAvatarHistoryHandler(cfg.AuthenticatePrincipal, cfg.GetSelfAvatarHistory))
		}
		if cfg.GetSelfAvatarVersion != nil {
			mux.HandleFunc("GET /v1/self/avatar/versions/{version}", getSelfAvatarVersionHandler(cfg.AuthenticatePrincipal, cfg.GetSelfAvatarVersion))
		}
		if cfg.GetSelfAvatarStyle != nil {
			mux.HandleFunc("GET /v1/self/avatar/style", getSelfAvatarStyleHandler(cfg.AuthenticatePrincipal, cfg.GetSelfAvatarStyle))
		}
		if cfg.ProposeSelfAvatar != nil {
			mux.HandleFunc("POST /v1/self/avatar/proposals", proposeSelfAvatarHandler(cfg.AuthenticatePrincipal, cfg.ProposeSelfAvatar))
		}
		if cfg.ActivateSelfAvatar != nil {
			mux.HandleFunc("POST /v1/self/avatar:activate", activateSelfAvatarHandler(cfg.AuthenticatePrincipal, cfg.ActivateSelfAvatar))
		}
		if cfg.RollbackSelfAvatar != nil {
			mux.HandleFunc("POST /v1/self/avatar:rollback", rollbackSelfAvatarHandler(cfg.AuthenticatePrincipal, cfg.RollbackSelfAvatar))
		}
		if cfg.ResetSelfAvatar != nil {
			mux.HandleFunc("POST /v1/self/avatar:reset", resetSelfAvatarHandler(cfg.AuthenticatePrincipal, cfg.ResetSelfAvatar))
		}
		if cfg.ReportSelfAvatarGenerationFailure != nil {
...
func selfHandler(
	...
	return requireDomainPrincipal(auth, func(w http.ResponseWriter, r *http.Request, p DomainPrincipal) {
		...
		if raw := q.Get("include_avatar_checkpoint"); raw != "" {
			includeAvatarCheckpoint, _ = strconv.ParseBool(raw)
		}
		var avatarCheckpoint *SelfAvatarCheckpoint
		if includeAvatarCheckpoint && getAvatarCheckpoint != nil {
			var err error
			avatarCheckpoint, err = getAvatarCheckpoint(r.Context(), p)
			if err != nil {
...
func accountLifecycleHandler(cfg Config) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if accountID, ok := pathActionID(r.URL.Path, "/v1/accounts/", "plan-fit-apply"); ok && cfg.ApplyAccountPlanIfFits != nil {
			var req struct {
				SchemaVersion string                   `json:"schema_version"`
			...
			decoder.DisallowUnknownFields()
			if err := decoder.Decode(&req); err != nil {
				writeJSONError(w, http.StatusBadRequest, "invalid plan-fit apply target snapshot")
				return
			}
			var extra any
			if err := decoder.Decode(&extra); !errors.Is(err, io.EOF) ||
				req.SchemaVersion != "witself.v0" ||
				!validPlanFitApplyTargetRecord(req.Target) {
				writeJSONError(w, http.StatusBadRequest, "invalid plan-fit apply target snapshot")
				return
			}
			result, err := cfg.ApplyAccountPlanIfFits(
				r.Context(), accountID, req.Target,
			)
			switch {
			case errors.Is(err, ErrNotFound):
				writeJSONError(w, http.StatusNotFound, "account not found")
				return
			case errors.Is(err, ErrConflict):
				writeJSONError(w, http.StatusConflict, "stale or conflicting plan-fit apply")
				return
			case errors.Is(err, ErrInvalidPlanSnapshot), errors.Is(err, ErrBadInput):
				writeJSONError(w, http.StatusBadRequest, "invalid plan-fit apply target snapshot")
				return
			case err != nil:
				writeJSONError(w, http.StatusInternalServerError, "could not apply account plan after fit")
				return
			}
			if !validPlanFitApplyResult(accountID, req.Target, result) {
				writeJSONError(w, http.StatusInternalServerError, "invalid plan-fit apply result")
				return
			}
			result.SchemaVersion = "witself.v0"
			w.Header().Set("Content-Type", "application/json")
...
func closeAccountHandler(auth AuthFunc, closeAccount func(ctx context.Context, accountID, operatorID, reason string) error) http.HandlerFunc {
	return requireOperatorAnyStatus(auth, func(w http.ResponseWriter, r *http.Request, p principal) {
		...
		case errors.Is(err, ErrCannotCloseDefault):
			...
			return
		case errors.Is(err, ErrConflict):
			writeJSONError(w, http.StatusConflict, "active vault key enrollment or rotation must be cancelled before closing the account")
			return
		case err != nil:
...
func deleteAgentHandler(auth AuthFunc, deleteAgent func(ctx context.Context, accountID, realmID, agentID string) error) http.HandlerFunc {
	return requireOperator(auth, func(w http.ResponseWriter, r *http.Request, p principal) {
		...
		case errors.Is(err, ErrNotFound):
			...
			return
		case errors.Is(err, ErrConflict):
			writeJSONError(w, http.StatusConflict, "active vault key enrollment or rotation must be cancelled before deleting the agent")
			return
		case err != nil:
