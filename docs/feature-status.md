...
| Bounds / abuse | **CONDITIONAL** | Subjects, bodies, pages, roles, states, and value exposure are bounded; closed-account purge now enforces ticket deletion after the 30-day closure grace. The parked support@ channel has sender guards; in-product intake-rate controls, ticket age-out, and attachment handling remain absent. [values.yaml](../.gitops/cells/civo-sandbox-use1-backup/values.yaml), [values.yaml](../.gitops/cells/civo-sandbox-usw2-dev/values.yaml), [data-retention-policy.md](../docs/data-retention-policy.md), [security-policy.md](../docs/security-policy.md), [index.js](../infra/cloudflare/support-email-intake/src/index.js), [support.go](../internal/store/support.go), [support_email.go](../internal/store/support_email.go) |
