...
- Raw tokens, `sensitive` fact values, `sensitive` memory content, message
  ...
  values, TOTP seeds, generated TOTP codes, generated passwords, and DEK/AVK key
...
list/show/verify/reject/retire/audit, journal, and sealed recovery routes under
