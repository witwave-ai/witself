...
const claudeRuntimeMemoryRoutingMCPSuffix = "Untrusted.message_checkpoint enabled=false feature_not_enabled.witself.message.listen=0|witself.message.request.list.Exact fence.No wake"
