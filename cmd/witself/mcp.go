...
func (in mcpSelfShowInput) options() (client.SelfOptions, error) {
	...
	return client.SelfOptions{
		...
		IncludeEmailCheckpoint: true, IncludeAvatarCheckpoint: true,
